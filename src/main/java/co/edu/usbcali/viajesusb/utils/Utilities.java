...
public class Utilities {
	...
	/**
	 * MÃ©todo para valida emails
	 * 
	 * @author Camilo Andres Cifuentes Grass
	 * @version 2018/01/17
	 * @param sEmail el email a verificar
	 * @return true si es un email valido, false en caso que no sea.
	 */
	...
	/**
	 * FuncÃ­Ã³n para redondear un nÃºmero double a los decimales que le ingresen
	 * 
	...
	/**
	 * FunciÃ³n para obtener el nÃºmero que sea mÃºltiplo de "multiploDe" y mayor
	 * que "mayorQue"
	 *
	 * @author Camilo Delgado
	 * @version Mar 24, 2018
	 ...
	 * 
	 * @Title: isLongerThan
	 * @Description: PREGUNTA SI LA LONGITUD DE UN TEXTO ES MAYOR O NO A UN NUMERO
	 *               ESPECIFICADO
	 * @param: @param  texto
	 * @param: @param  number
	 * @param: @return
